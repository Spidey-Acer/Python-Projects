...
unique_visitors = df3.groupby('URL Path').size().reset_index(name='Counts')

# Create a pivot table for the heatmap
heatmap_data = unique_visitors.pivot_table(index='URL Path', values='Counts', aggfunc='sum')

plt.figure(figsize=(10, 5))
sns.heatmap(heatmap_data, cmap="YlGnBu", annot=True, fmt='g')  # Added annot=True to show counts
